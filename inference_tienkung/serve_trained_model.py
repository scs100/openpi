...
python inference_piper/serve_trained_model.py \
     --checkpoint_dir checkpoints/lora_training/rgb_sgd09_bat6_lr1e41e6_clip3/80000 \
     --config_name lora_training \
     --default_prompt "pick_up_parts_from_belt_conveyor_place_on_plate_fast" \
     --dataset_name "pick_up_parts_from_belt_conveyor_place_on_plate_fast" \
